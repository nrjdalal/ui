...
export default function CliCommands({ name }: { name: string }) {
  ...
  const commands = {
    pnpm: `pnpm dlx shadcn@latest add https://ui.nrjdalal.com/r/${name}.json`,
    npm: `npx shadcn@latest add https://ui.nrjdalal.com/r/${name}.json`,
    yarn: `npx dlx shadcn@latest add https://ui.nrjdalal.com/r/${name}.json`,
    bun: `bunx --bun shadcn@latest add https://ui.nrjdalal.com/r/${name}.json`,
  }
